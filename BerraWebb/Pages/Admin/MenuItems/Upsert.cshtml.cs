...
namespace BerraWebb.Pages.Admin.MenuItems;
...
public class UpsertModel : PageModel
{
    ...
    public IEnumerable<SelectListItem> MovieDurationList { get; set; }
    ...
    public void OnGet(int? id)
    {
        ...
        MovieDurationList = _unitOfWork.MovieDuration.GetAll().Select(i => new SelectListItem()
        {
            Text = i.Name,
            Value = i.Id.ToString()
        });
